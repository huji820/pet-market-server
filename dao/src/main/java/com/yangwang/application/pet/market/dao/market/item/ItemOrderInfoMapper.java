 ...
 */
@Mapper
public interface ItemOrderInfoMapper {
     ...
     **/
    List<ItemOrderInfo> listByOrderNo(@Param("orderNo") String orderNo);
     ...
     **/
    ItemOrderInfo getByOrderInfoNo(@Param("orderInfoNo") String orderInfoNo);
}
