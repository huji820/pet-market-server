...
public class MessagePushServiceImpl implements MessagePushService {
    ...
    public void messagePushBusiness(String commodityNo, Integer messageType,String orderNo) {
        ...
        com.yangwang.application.pet.market.model.service.Service service = serviceInfoMapper.getByServiceId(serviceOrder.getService().getServiceID());
        //获取商家的编号
        Business business = businessService.getByBusinessNoWithOutState(commodityNo);
        String businessNo = business.getBusinessNo();

        String messageTitle = MessageTypeEnum.getMsgByType(messageType);
        String nowTime = DateUtil.format(new Date(), DateUtil.FORMAT_FULL);
        String messageContact = "您的服务"+service.getServiceName()+"已售出,请及时处理订单，订单编号为"+orderNo+"。";
